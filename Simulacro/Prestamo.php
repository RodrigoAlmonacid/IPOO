...
class Prestamo{
    ...
    //Método constructor
    public function __construct($monto, $cantCuotas, $tazaInteres, Cliente $objCliente, $colCuotas)
    {
        self::$generaCodigo++;
    ...
    public function otorgarPrestamo(){
        ...
        $monto_total = $this->getMonto();
        do{
            $prestamo[$i] = ($monto_total/$cuotas) + $this->calcularInteresPrestamo($i); 
            $i++;
        }while($i<$cuotas);
